...
// non-regex comment stripping
// source: https://j11y.io/javascript/removing-comments-in-javascript/
function commentStripper(str) {
    str = ('__' + str + '__').split('');
    const mode = {
        singleQuote: false,
        doubleQuote: false,
...
function serialize(func, opts) {
  ...
  // strip any comments
  if (!opts.comments) {
    stringified = commentStripper(stringified);
  }
